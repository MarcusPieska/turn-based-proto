...
LOGS = [
    ...
    ("WarMuster", "unsigned seat, unsigned enemy, unsigned n", "war muster seat=%u enemy=%u muster_n=%u\n"),
    ("WarPeaceMock", "unsigned seat, unsigned x, unsigned y", "war peace mock-fail seat=%u city=(%u,%u)\n"),
