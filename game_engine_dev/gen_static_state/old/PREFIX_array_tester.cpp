...
class [CLASS_NAME_PREFIX]Accessor {
public:
    static [CLASS_NAME_PREFIX]Key make_key (u16 raw) {
        return [CLASS_NAME_PREFIX]Key(raw);
    }
};

void assert_all_clear ([CLASS_NAME_PREFIX]Array& arr, u16 count, cstr prefix) {
    for (u16 i = 0; i < count; ++i) {
        [CLASS_NAME_PREFIX]Key key = [CLASS_NAME_PREFIX]Accessor::make_key(i);
...
void test_array_starts_clear () {
    ...
    [CLASS_NAME_PREFIX]Array arr(flag_count);
    assert_all_clear(arr, flag_count, "[CLASS_NAME_PREFIX]Array starts clear");
...
void test_set_flag_roundtrip () {
    const u16 flag_count = 16;
    [CLASS_NAME_PREFIX]Array arr(flag_count);
    [CLASS_NAME_PREFIX]Key key = [CLASS_NAME_PREFIX]Accessor::make_key(5);
...
void test_multiple_flags_independent () {
    ...
    [CLASS_NAME_PREFIX]Key key_a = [CLASS_NAME_PREFIX]Accessor::make_key(2);
    [CLASS_NAME_PREFIX]Key key_b = [CLASS_NAME_PREFIX]Accessor::make_key(9);
    [CLASS_NAME_PREFIX]Key key_c = [CLASS_NAME_PREFIX]Accessor::make_key(13);
...
void test_none_key_access () {
    const u16 flag_count = 16;
    [CLASS_NAME_PREFIX]Array arr(flag_count);
    [CLASS_NAME_PREFIX]Key none_key = [CLASS_NAME_PREFIX]Key::None();
...
int main (int argc, char* argv[]) {
    ...
    printf("=======================================================\n");
    printf(" TESTING [CLASS_NAME_PREFIX] ARRAY: TOTAL FAILURES: %d/%d\n", total_test_fails, total_tests_run);
    printf("=======================================================\n");
