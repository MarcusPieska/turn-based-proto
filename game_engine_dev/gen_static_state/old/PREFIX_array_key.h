...
#ifndef [MACRO_PREFIX]_ARRAY_KEY_H
#define [MACRO_PREFIX]_ARRAY_KEY_H
...
class [CLASS_NAME_PREFIX]Key {
    friend class [CLASS_NAME_PREFIX]Array;
    friend class [CLASS_NAME_PREFIX]Accessor;
public:
...
#endif // [MACRO_PREFIX]_ARRAY_KEY_H
