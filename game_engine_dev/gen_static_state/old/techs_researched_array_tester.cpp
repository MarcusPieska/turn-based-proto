...
class TechsResearchedAccessor {
public:
    static TechsResearchedKey make_key (u16 raw) {
        return TechsResearchedKey(raw);
    }
};

void assert_all_clear (TechsResearchedArray& arr, u16 count, cstr prefix) {
    for (u16 i = 0; i < count; ++i) {
        TechsResearchedKey key = TechsResearchedAccessor::make_key(i);
...
void test_array_starts_clear () {
    ...
    TechsResearchedArray arr(flag_count);
    assert_all_clear(arr, flag_count, "TechsResearchedArray starts clear");
...
void test_set_flag_roundtrip () {
    const u16 flag_count = 16;
    TechsResearchedArray arr(flag_count);
    TechsResearchedKey key = TechsResearchedAccessor::make_key(5);
...
void test_multiple_flags_independent () {
    ...
    TechsResearchedKey key_a = TechsResearchedAccessor::make_key(2);
    TechsResearchedKey key_b = TechsResearchedAccessor::make_key(9);
    TechsResearchedKey key_c = TechsResearchedAccessor::make_key(13);
...
void test_none_key_access () {
    const u16 flag_count = 16;
    TechsResearchedArray arr(flag_count);
    TechsResearchedKey none_key = TechsResearchedKey::None();
...
int main (int argc, char* argv[]) {
    ...
    printf("=======================================================\n");
    printf(" TESTING TechsResearched ARRAY: TOTAL FAILURES: %d/%d\n", total_test_fails, total_tests_run);
    printf("=======================================================\n");
