...
compile_assessor_deps () {
    ...
    g++ $INC -c $DIO/toggle_city_parser.cpp -o toggle_city_parser.o toggle_civ_parser.o toggle_global_parser.o
    g++ $INC -c $DIO/toggle_civ_parser.cpp -o toggle_civ_parser.o
    g++ $INC -c $DIO/toggle_global_parser.cpp -o toggle_global_parser.o
    ...
    g++ $INC -c ../../static_state/toggle_city_static_data.cpp -o toggle_city_static_data.o toggle_civ_static_data.o toggle_global_static_data.o
    g++ $INC -c ../../static_state/toggle_civ_static_data.cpp -o toggle_civ_static_data.o
    g++ $INC -c ../../static_state/toggle_global_static_data.cpp -o toggle_global_static_data.o
