...
struct TotalTileYield {
    ...
    u32 m_pops_assigned; // Total population assigned to worked tiles
};
...
//  Stable-food helpers keep upkeep (2*sanitation_boost) with start_food as the city-center budget, then greedily chase secondary.
//  Once the food target is met, only lean (0-food) tiles are still assigned; otherwise the loop stops and leftover pops are for city jobs.
...
public:
    ...
    static TotalTileYield stable_food_max_production (u16 player, u16 city_idx, u16 start_food, u16 sanitation_boost);
    static TotalTileYield stable_food_max_commerce (u16 player, u16 city_idx, u16 start_food, u16 sanitation_boost);
    static TotalTileYield stable_food_max_combined (u16 player, u16 city_idx, u16 start_food, u16 sanitation_boost);
...
private:
    ...
    static TotalTileYield assign_stable_food (u16 player, u16 city_idx, u16 start_food, u16 sanitation_boost, u8 sec_mode);
};
