...
void test_get_item_returns_expected_struct_by_key () {
    ...
    const TechStaticDataStruct& item = data.get_item(key);
...
void test_set_items_can_replace_array_and_count () {
    ...
    items_b[0].cost = 31; items_b[0].tier = 131;
    items_b[1].cost = 32; items_b[1].tier = 132;
    items_b[2].cost = 33; items_b[2].tier = 133;
    items_b[3].cost = 34; items_b[3].tier = 134;
    items_b[4].cost = 35; items_b[4].tier = 135;
...
void test_zero_count_is_allowed () {
    ...
    items[0].cost = 41; items[0].tier = 141;
    TechStaticData data;
...
void test_take_ownership_copies_backing_array () {
    TechStaticDataStruct* items = new TechStaticDataStruct[2];
    items[0].cost = 51; items[0].tier = 151;
    items[1].cost = 52; items[1].tier = 152;
    TechStaticData data;
    data.set_items(items, 2);
    TechStaticDataKey key = TechStaticDataTester::make_key(1);
    ...
    note_result(item.tier == 152, "take_ownership preserves member2");
    data.release_items();
    summarize_test_results();
}
