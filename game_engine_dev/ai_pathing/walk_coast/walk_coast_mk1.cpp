...
//================================================================================================================================
//=> - WalkCoastMk1 static helpers -
//================================================================================================================================

static bool s_is_coast (const GameArraySimple& map, u16 x, u16 y) {
    return map.get_terrain(x, y) == TERR_COASTAL[0];
}
...
static bool s_has_coast_nbr (const GameArraySimple& map, u16 x, u16 y) {
...
static bool s_is_walk (const GameArraySimple& map, u16 x, u16 y) {
    return s_is_path(map, x, y) && s_has_coast_nbr(map, x, y);
}
...
u16 WalkCoastMk1::can_ai_start_from (
...
WalkCoastMk1::WalkCoastMk1 (const GameArraySimple& map, MapBitOverlay& exp, u16 sx, u16 sy, u16 sight, u8 player) :
    m_map(map),
    m_exp(exp),
    m_pos{sx, sy},
    m_win{sx, sy},
