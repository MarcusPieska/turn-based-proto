...
static const cstr RE_OUT = "/home/w/Projects/simple-map-gen/walk_river_mk1_result.ppm";
static const cstr RE_SYS_MAP = "/home/w/Projects/simple-map-gen/walk_river_mk1_sysmap.ppm";
static const cstr RE_BAD_MAP = "/home/w/Projects/simple-map-gen/walk_river_mk1_badmap.ppm";
static const cstr RE_FRAMES = "/home/w/Projects/simple-map-gen/walk_river_mk1_frames";
static const cstr RE_TRACE = "walk_river_mk1_test.trace";
...
int main (int argc, char** argv) {
    ...
    PathMk1 gre_start;
    if (verbose) {
        std::printf("walk_river_mk1: %ux%u turns %u moves %u sight %u\n",
    ...
    while (sys_n < RE_SYS_MAX && finder.find_next(ux, uy)) {
        ...
        WalkRiverMk1 ai(map, exp, ux, uy, RE_SIGHT, 0u);
        exp.set(ux, uy);
