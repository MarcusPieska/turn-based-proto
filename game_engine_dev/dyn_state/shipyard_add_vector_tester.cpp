...
void test_first_item_zero_initialized () {
    ...
    ShipyardAddItem* should_be_null = array.get_shipyard_add(ShipyardAddKey::None());
...
void test_null_key_reserved () {
    ShipyardAddVector array;
    ShipyardAddItem* null_item = array.get_shipyard_add(ShipyardAddKey::None());
...
void test_return_null_is_noop () {
    ...
    array.return_shipyard_add(ShipyardAddKey::None());
...
void test_reuse_recycled_slot_lifo () {
    ...
    if (ok) {
        ...
        if (ShipyardAddVectorTester::get_head_count(array) != 4) {
            ok = false;
        }
    }
