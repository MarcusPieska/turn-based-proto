...
public:
    ...
    void print_state(MonasteryAddVector& array) {
        ...
        for (u16 i = 0; i < limit; ++i) {
            char c = '-';
            MonasteryAddStruct* item = array.get_monastery_add(MonasteryAddKey::from_raw(i));
            if (item != nullptr) {
                c = '1';
...
static void test_large_return_and_reuse () {
    ...
    note_result(head_before_returns == start_count, "After creating start_count entries, head/frontier == start_count");
