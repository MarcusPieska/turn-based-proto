...
PlayerUnitSaveTimelineMng::PlayerUnitSaveTimelineMng ()
    : m_tl(nullptr),
      m_seat(nullptr),
      m_player_n(0),
      m_save_n(0) {
...
void PlayerUnitSaveTimelineMng::clr () {
    delete[] m_tl;
    m_tl = nullptr;
    delete[] m_seat;
    m_seat = nullptr;
...
bool PlayerUnitSaveTimelineMng::setup (u16 player_n, u16 save_n) {
    clr();
...
bool PlayerUnitSaveTimelineMng::fill (const EvalPaths& paths) {
...
void PlayerUnitSaveTimelineMng::sort () {
...
u16 PlayerUnitSaveTimelineMng::player_n () const {
    return m_player_n;
}

u16 PlayerUnitSaveTimelineMng::save_n () const {
    return m_save_n;
}

PlayerUnitSaveTimeline& PlayerUnitSaveTimelineMng::at (u16 i) {
    return m_tl[i];
}

const PlayerUnitSaveTimeline& PlayerUnitSaveTimelineMng::at (u16 i) const {
    return m_tl[i];
}

u16 PlayerUnitSaveTimelineMng::seat (u16 i) const {
