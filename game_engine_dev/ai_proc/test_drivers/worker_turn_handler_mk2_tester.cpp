...
static const char* G_OUT_DIR_REMOTE = "/home/w/Projects/simple-map-gen/worker-turn-mng-mk2";
static const char* G_OUT_DIR_PATH = "/home/w/Projects/simple-map-gen/worker-turn-mng-mk2-path";
...
int main (int argc, char** argv) {
    ...
    g_unit_tile.clear();
    g_job_tot.clear();
    WorkerTurnHandlerMk2::set_job_note(on_job);
    ...
    if (!g_time_only) {
        if (!save_turn_ppm(state, 0)) {
            ...
            WorkerTurnHandlerMk2::set_job_note(nullptr);
