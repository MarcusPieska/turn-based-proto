...
static const char* G_OUT_DIR = "/home/w/Projects/simple-map-gen/city-production-turn-handler-test";
static const char* G_TRACE = "/home/w/Projects/simple-map-gen/city-production-turn-handler-test/game_loop.trace";
static const char* G_CITY_LOG = "/home/w/Projects/simple-map-gen/city-production-turn-handler-test/cities.trace";
...
int main (int argc, char** argv) {
    ...
    const u16 cn = state.m_cities.get_city_count();
    std::printf("=======================================================\n");
    std::printf(" CITY PRODUCTION TURN HANDLER: done turns=%u cities=%u out=%s\n",
