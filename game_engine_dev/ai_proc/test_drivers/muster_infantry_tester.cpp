...
static const cstr G_OUT = "/home/w/Projects/simple-map-gen/conduct-muster-infantry";
...
int main (int argc, char** argv) {
    ...
    Whiteboard_2B ov_wb("muster_infantry_tester", "ov", 0u);
    if (!ov_wb.ok()) {
    ...
    Whiteboard_1B msk("muster_infantry_tester", "msk", 0u);
    ...
    std::printf("*** PASSED muster_infantry (2 spear, 3 sword, 2 catapult)\n");
    WhiteboardMng::terminate();
    return 0;
}
