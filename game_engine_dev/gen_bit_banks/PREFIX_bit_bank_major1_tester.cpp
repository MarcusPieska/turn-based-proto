...
void test_claim_2500_batches_without_crash_11_flags_per_batch () {
    ...
    note_result([USER_CLASS_NAME]::get_claimed_batch_count(*bank) == batch_count, "Claimed batch count is 2500");
    note_result([USER_CLASS_NAME]::get_allocated_page_count(*bank) == 10, "2500 batches allocate 10 pages");
    note_result([USER_CLASS_NAME]::get_page(*bank, 0) != nullptr, "Page 0 allocated");
    note_result([USER_CLASS_NAME]::get_page(*bank, 3) != nullptr, "Page 3 allocated");
