...
#ifndef TOGGLE_GLOBAL_PARSER_TESTER_H
#define TOGGLE_GLOBAL_PARSER_TESTER_H
...
//================================================================================================================================
//=> - ToggleGlobalParserTester class -
//================================================================================================================================

class ToggleGlobalParserTester {
public:
    ToggleGlobalParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const ToggleGlobalStaticDataStruct& item);
...
private:
    ...
    static ToggleGlobalParserTester* s_inst;
...
#endif // TOGGLE_GLOBAL_PARSER_TESTER_H
