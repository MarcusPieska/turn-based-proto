...
#ifndef WORKER_JOB_IMP_PARSER_TESTER_H
#define WORKER_JOB_IMP_PARSER_TESTER_H
...
//================================================================================================================================
//=> - WorkerJobImpParserTester class -
//================================================================================================================================

class WorkerJobImpParserTester {
public:
    WorkerJobImpParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const WorkerJobImpStaticDataStruct& item);
...
private:
    ...
    static WorkerJobImpParserTester* s_inst;
...
#endif // WORKER_JOB_IMP_PARSER_TESTER_H
