...
public:
    ...
    cstr get_path_to_map_terrains () const;
    cstr get_path_to_map_climates () const;
...
private:
    ...
    char m_path_map_terrains[PATH_MNG_PATH_N];
    char m_path_map_climates[PATH_MNG_PATH_N];
