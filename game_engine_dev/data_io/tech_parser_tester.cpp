...
TechParserTester* TechParserTester::s_inst = NULL;

//================================================================================================================================
//=> - TechParserTester implementation -
//================================================================================================================================

TechParserTester::TechParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
    m_city_flag_sd(NULL),
...
void TechParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void TechParserTester::set_city_flag_sd (const CityFlagStaticData* sd) {

    m_city_flag_sd = sd;

}

void TechParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void TechParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void TechParserTester::set_resource_sd (const ResourceStaticData* sd) {
...
void TechParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void TechParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void TechParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void TechParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {
...
FILE* TechParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void TechParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_TECH", "w");
}

void TechParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void TechParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool TechParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 TechParserTester::st_building_n2i (cstr name) {
...
u16 TechParserTester::st_city_flag_n2i (cstr name) {
...
u16 TechParserTester::st_civ_n2i (cstr name) {
...
u16 TechParserTester::st_civ_trait_n2i (cstr name) {
...
u16 TechParserTester::st_resource_n2i (cstr name) {
...
u16 TechParserTester::st_tech_n2i (cstr name) {
...
u16 TechParserTester::st_unit_n2i (cstr name) {
...
u16 TechParserTester::st_unit_action_n2i (cstr name) {
...
u16 TechParserTester::st_unit_type_n2i (cstr name) {
...
u16 TechParserTester::st_wonder_n2i (cstr name) {
...
void TechParserTester::pr_u32 (cstr label, u32 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void TechParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void TechParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void TechParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void TechParserTester::pr_item (const TechStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", item.name.c_str());
...
int TechParserTester::run () {
    ...
    if (!raw_items.load_file_content("../game_config.techs")) {
        s_inst = NULL;
        return 0;
    }
    ...
    TechParser parser(raw_items, cbs);
    TechStaticDataStruct* parsed_data = parser.parse_data_dependencies();
    if (m_plvl >= 2) {
