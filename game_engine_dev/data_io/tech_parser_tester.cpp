...
void TechParserTester::set_toggle_city_sd (const ToggleCityStaticData* sd) {

    m_toggle_city_sd = sd;

}

void TechParserTester::set_toggle_civ_sd (const ToggleCivStaticData* sd) {

    m_toggle_civ_sd = sd;

}

void TechParserTester::set_toggle_global_sd (const ToggleGlobalStaticData* sd) {

    m_toggle_global_sd = sd;

}

void TechParserTester::set_city_job_sd (const CityJobStaticData* sd) {
...
void TechParserTester::set_tile_attribute_sd (const TileAttributeStaticData* sd) {
...
void TechParserTester::set_res_dist_sd (const ResDistStaticData* sd) {
...
void TechParserTester::set_tech_era_sd (const TechEraStaticData* sd) {

    m_tech_era_sd = sd;

}

void TechParserTester::set_tech_age_sd (const TechAgeStaticData* sd) {
...
void TechParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {
...
void TechParserTester::set_unit_domain_sd (const UnitDomainStaticData* sd) {
...
void TechParserTester::set_map_overlay_sd (const MapOverlayStaticData* sd) {

    m_map_overlay_sd = sd;

}

void TechParserTester::set_map_attribute_sd (const MapAttributeStaticData* sd) {

    m_map_attribute_sd = sd;

}

void TechParserTester::set_map_terrain_sd (const MapTerrainStaticData* sd) {

    m_map_terrain_sd = sd;

}

void TechParserTester::set_map_climate_sd (const MapClimateStaticData* sd) {

    m_map_climate_sd = sd;

}

void TechParserTester::set_worker_job_target_sd (const WorkerJobTargetStaticData* sd) {

    m_worker_job_target_sd = sd;

}

void TechParserTester::set_worker_job_type_sd (const WorkerJobTypeStaticData* sd) {
...
void TechParserTester::set_worker_job_imp_sd (const WorkerJobImpStaticData* sd) {

    m_worker_job_imp_sd = sd;

}

void TechParserTester::set_tile_yield_type_sd (const TileYieldTypeStaticData* sd) {

    m_tile_yield_type_sd = sd;

}

void TechParserTester::set_improvement_yield_sd (const ImprovementYieldStaticData* sd) {
...
u16 TechParserTester::st_toggle_city_n2i (cstr name) {
...
u16 TechParserTester::st_toggle_civ_n2i (cstr name) {
...
u16 TechParserTester::st_toggle_global_n2i (cstr name) {
...
u16 TechParserTester::st_city_job_n2i (cstr name) {
...
u16 TechParserTester::st_tile_attribute_n2i (cstr name) {
...
u16 TechParserTester::st_res_dist_n2i (cstr name) {
...
u16 TechParserTester::st_tech_era_n2i (cstr name) {
...
u16 TechParserTester::st_tech_age_n2i (cstr name) {
...
u16 TechParserTester::st_unit_role_n2i (cstr name) {
...
u16 TechParserTester::st_unit_domain_n2i (cstr name) {
...
u16 TechParserTester::st_map_overlay_n2i (cstr name) {
...
u16 TechParserTester::st_map_attribute_n2i (cstr name) {
...
u16 TechParserTester::st_map_terrain_n2i (cstr name) {
...
u16 TechParserTester::st_map_climate_n2i (cstr name) {
...
u16 TechParserTester::st_worker_job_target_n2i (cstr name) {
...
u16 TechParserTester::st_worker_job_type_n2i (cstr name) {
...
u16 TechParserTester::st_worker_job_imp_n2i (cstr name) {
...
u16 TechParserTester::st_tile_yield_type_n2i (cstr name) {
...
u16 TechParserTester::st_improvement_yield_n2i (cstr name) {
...
void TechParserTester::pr_i16 (cstr label, i16 value) {
    fprintf(out(), "  %s: %d\n", label, (int)value);
}
...
void TechParserTester::pr_item (cstr name, const TechStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
    pr_u32("cost", item.cost);
    pr_u16("tier", item.tier);
