...
#ifndef WORKER_JOB_TARGET_PARSER_TESTER_H
#define WORKER_JOB_TARGET_PARSER_TESTER_H
...
//================================================================================================================================
//=> - WorkerJobTargetParserTester class -
//================================================================================================================================

class WorkerJobTargetParserTester {
public:
    WorkerJobTargetParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const WorkerJobTargetStaticDataStruct& item);
...
private:
    ...
    static WorkerJobTargetParserTester* s_inst;
...
#endif // WORKER_JOB_TARGET_PARSER_TESTER_H
