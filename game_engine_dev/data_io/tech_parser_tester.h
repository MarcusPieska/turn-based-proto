...
#ifndef TECH_PARSER_TESTER_H
#define TECH_PARSER_TESTER_H
...
//================================================================================================================================
//=> - TechParserTester class -
//================================================================================================================================

class TechParserTester {
public:
    TechParserTester ();
    void set_plvl (int lvl);
    int run ();
    void pr_item (const TechStaticDataStruct& item);
...
private:
    ...
    static TechParserTester* s_inst;
