...
//================================================================================================================================
//=> - SmallWonderParser implementation -
//================================================================================================================================

SmallWonderParser::SmallWonderParser (const std::vector<RawItem>& items, const NameToIdxCbs& map) : DataParserBase(items, map) {
}

SmallWonderStaticDataStruct* SmallWonderParser::parse_data_dependencies () {
    SmallWonderStaticDataStruct* parsed_data = new SmallWonderStaticDataStruct[m_item_count]();
