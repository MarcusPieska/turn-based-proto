...
#ifndef MAP_CLIMATE_PARSER_TESTER_H
#define MAP_CLIMATE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - MapClimateParserTester class -
//================================================================================================================================

class MapClimateParserTester {
public:
    MapClimateParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const MapClimateStaticDataStruct& item);
...
private:
    ...
    static MapClimateParserTester* s_inst;
...
#endif // MAP_CLIMATE_PARSER_TESTER_H
