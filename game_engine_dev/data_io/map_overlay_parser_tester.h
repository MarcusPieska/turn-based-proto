...
#ifndef MAP_OVERLAY_PARSER_TESTER_H
#define MAP_OVERLAY_PARSER_TESTER_H
...
//================================================================================================================================
//=> - MapOverlayParserTester class -
//================================================================================================================================

class MapOverlayParserTester {
public:
    MapOverlayParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const MapOverlayStaticDataStruct& item);
...
private:
    ...
    static MapOverlayParserTester* s_inst;
...
#endif // MAP_OVERLAY_PARSER_TESTER_H
