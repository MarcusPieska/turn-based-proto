...
#ifndef UNIT_TYPE_PARSER_TESTER_H
#define UNIT_TYPE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - UnitTypeParserTester class -
//================================================================================================================================

class UnitTypeParserTester {
public:
    UnitTypeParserTester ();
    void set_plvl (int lvl);
    int run ();
    void pr_item (const UnitTypeStaticDataStruct& item);
...
private:
    ...
    static UnitTypeParserTester* s_inst;
...
#endif // UNIT_TYPE_PARSER_TESTER_H
