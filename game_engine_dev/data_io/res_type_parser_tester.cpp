...
ResTypeParserTester* ResTypeParserTester::s_inst = NULL;

//================================================================================================================================
//=> - ResTypeParserTester implementation -
//================================================================================================================================

ResTypeParserTester::ResTypeParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
...
void ResTypeParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void ResTypeParserTester::set_toggle_city_sd (const ToggleCityStaticData* sd) {

    m_toggle_city_sd = sd;

}

void ResTypeParserTester::set_toggle_civ_sd (const ToggleCivStaticData* sd) {

    m_toggle_civ_sd = sd;

}

void ResTypeParserTester::set_toggle_global_sd (const ToggleGlobalStaticData* sd) {

    m_toggle_global_sd = sd;

}

void ResTypeParserTester::set_city_job_sd (const CityJobStaticData* sd) {

    m_city_job_sd = sd;

}

void ResTypeParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void ResTypeParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void ResTypeParserTester::set_tile_attribute_sd (const TileAttributeStaticData* sd) {

    m_tile_attribute_sd = sd;

}

void ResTypeParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void ResTypeParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void ResTypeParserTester::set_res_type_sd (const ResTypeStaticData* sd) {

    m_res_type_sd = sd;

}

void ResTypeParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void ResTypeParserTester::set_tech_era_sd (const TechEraStaticData* sd) {

    m_tech_era_sd = sd;

}

void ResTypeParserTester::set_tech_age_sd (const TechAgeStaticData* sd) {

    m_tech_age_sd = sd;

}

void ResTypeParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void ResTypeParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void ResTypeParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {

    m_unit_role_sd = sd;

}

void ResTypeParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void ResTypeParserTester::set_unit_domain_sd (const UnitDomainStaticData* sd) {

    m_unit_domain_sd = sd;

}

void ResTypeParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void ResTypeParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

void ResTypeParserTester::set_map_overlay_sd (const MapOverlayStaticData* sd) {

    m_map_overlay_sd = sd;

}

void ResTypeParserTester::set_map_attribute_sd (const MapAttributeStaticData* sd) {

    m_map_attribute_sd = sd;

}

void ResTypeParserTester::set_map_terrain_sd (const MapTerrainStaticData* sd) {

    m_map_terrain_sd = sd;

}

void ResTypeParserTester::set_map_climate_sd (const MapClimateStaticData* sd) {

    m_map_climate_sd = sd;

}

void ResTypeParserTester::set_worker_job_target_sd (const WorkerJobTargetStaticData* sd) {

    m_worker_job_target_sd = sd;

}

void ResTypeParserTester::set_worker_job_type_sd (const WorkerJobTypeStaticData* sd) {

    m_worker_job_type_sd = sd;

}

void ResTypeParserTester::set_worker_job_sd (const WorkerJobStaticData* sd) {

    m_worker_job_sd = sd;

}

void ResTypeParserTester::set_worker_job_imp_sd (const WorkerJobImpStaticData* sd) {

    m_worker_job_imp_sd = sd;

}

void ResTypeParserTester::set_tile_yield_type_sd (const TileYieldTypeStaticData* sd) {

    m_tile_yield_type_sd = sd;

}

void ResTypeParserTester::set_improvement_yield_sd (const ImprovementYieldStaticData* sd) {

    m_improvement_yield_sd = sd;

}

FILE* ResTypeParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void ResTypeParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_RES_TYPE", "w");
}

void ResTypeParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void ResTypeParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool ResTypeParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 ResTypeParserTester::st_building_n2i (cstr name) {
...
u16 ResTypeParserTester::st_toggle_city_n2i (cstr name) {
...
u16 ResTypeParserTester::st_toggle_civ_n2i (cstr name) {
...
u16 ResTypeParserTester::st_toggle_global_n2i (cstr name) {
...
u16 ResTypeParserTester::st_city_job_n2i (cstr name) {
...
u16 ResTypeParserTester::st_civ_n2i (cstr name) {
...
u16 ResTypeParserTester::st_civ_trait_n2i (cstr name) {
...
u16 ResTypeParserTester::st_tile_attribute_n2i (cstr name) {
...
u16 ResTypeParserTester::st_resource_n2i (cstr name) {
...
u16 ResTypeParserTester::st_res_dist_n2i (cstr name) {
...
u16 ResTypeParserTester::st_res_type_n2i (cstr name) {
...
u16 ResTypeParserTester::st_small_wonder_n2i (cstr name) {
...
u16 ResTypeParserTester::st_tech_era_n2i (cstr name) {
...
u16 ResTypeParserTester::st_tech_age_n2i (cstr name) {
...
u16 ResTypeParserTester::st_tech_n2i (cstr name) {
...
u16 ResTypeParserTester::st_unit_action_n2i (cstr name) {
...
u16 ResTypeParserTester::st_unit_role_n2i (cstr name) {
...
u16 ResTypeParserTester::st_unit_type_n2i (cstr name) {
...
u16 ResTypeParserTester::st_unit_domain_n2i (cstr name) {
...
u16 ResTypeParserTester::st_unit_n2i (cstr name) {
...
u16 ResTypeParserTester::st_wonder_n2i (cstr name) {
...
u16 ResTypeParserTester::st_map_overlay_n2i (cstr name) {
...
u16 ResTypeParserTester::st_map_attribute_n2i (cstr name) {
...
u16 ResTypeParserTester::st_map_terrain_n2i (cstr name) {
...
u16 ResTypeParserTester::st_map_climate_n2i (cstr name) {
...
u16 ResTypeParserTester::st_worker_job_target_n2i (cstr name) {
...
u16 ResTypeParserTester::st_worker_job_type_n2i (cstr name) {
...
u16 ResTypeParserTester::st_worker_job_n2i (cstr name) {
...
u16 ResTypeParserTester::st_worker_job_imp_n2i (cstr name) {
...
u16 ResTypeParserTester::st_tile_yield_type_n2i (cstr name) {
...
u16 ResTypeParserTester::st_improvement_yield_n2i (cstr name) {
...
void ResTypeParserTester::pr_u16 (cstr label, u16 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void ResTypeParserTester::pr_i16 (cstr label, i16 value) {
    fprintf(out(), "  %s: %d\n", label, (int)value);
}

void ResTypeParserTester::pr_u32 (cstr label, u32 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void ResTypeParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void ResTypeParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void ResTypeParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void ResTypeParserTester::pr_item (cstr name, const ResTypeStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
    // No parsing instructions provided
}

int ResTypeParserTester::run () {
    s_inst = this;
    NameToIdxCbs cbs = {};
    ...
    if (!ld_sm(raw_items, paths.get_path_to_res_types())) {
        s_inst = NULL;
        return 0;
    }
    ...
    ResTypeParser parser(raw_items, cbs);
    ResTypeStaticDataStruct* parsed_data = parser.parse_data_dependencies();
    if (m_plvl >= 2) {
