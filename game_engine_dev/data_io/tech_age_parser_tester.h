...
#ifndef TECH_AGE_PARSER_TESTER_H
#define TECH_AGE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - TechAgeParserTester class -
//================================================================================================================================

class TechAgeParserTester {
public:
    TechAgeParserTester ();
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const TechAgeStaticDataStruct& item);
...
private:
    ...
    static TechAgeParserTester* s_inst;
...
#endif // TECH_AGE_PARSER_TESTER_H
