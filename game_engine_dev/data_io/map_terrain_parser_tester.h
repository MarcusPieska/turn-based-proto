...
#ifndef MAP_TERRAIN_PARSER_TESTER_H
#define MAP_TERRAIN_PARSER_TESTER_H
...
//================================================================================================================================
//=> - MapTerrainParserTester class -
//================================================================================================================================

class MapTerrainParserTester {
public:
    MapTerrainParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const MapTerrainStaticDataStruct& item);
...
private:
    ...
    static MapTerrainParserTester* s_inst;
...
#endif // MAP_TERRAIN_PARSER_TESTER_H
