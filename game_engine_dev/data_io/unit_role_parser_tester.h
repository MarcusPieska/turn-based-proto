...
#ifndef UNIT_ROLE_PARSER_TESTER_H
#define UNIT_ROLE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - UnitRoleParserTester class -
//================================================================================================================================

class UnitRoleParserTester {
public:
    UnitRoleParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const UnitRoleStaticDataStruct& item);
...
private:
    ...
    static UnitRoleParserTester* s_inst;
    ...
    void pr_mods (const CombatModList& mods);
};

#endif // UNIT_ROLE_PARSER_TESTER_H
