...
#ifndef MVT_COST_PARSER_TESTER_H
#define MVT_COST_PARSER_TESTER_H
...
//================================================================================================================================
//=> - MvtCostParserTester class -
//================================================================================================================================

class MvtCostParserTester {
public:
    MvtCostParserTester ();
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const MvtCostStaticDataStruct& item);
...
private:
    ...
    static MvtCostParserTester* s_inst;
...
#endif // MVT_COST_PARSER_TESTER_H
