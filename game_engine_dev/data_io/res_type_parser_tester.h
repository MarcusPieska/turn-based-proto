...
#ifndef RES_TYPE_PARSER_TESTER_H
#define RES_TYPE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - ResTypeParserTester class -
//================================================================================================================================

class ResTypeParserTester {
public:
    ResTypeParserTester ();
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const ResTypeStaticDataStruct& item);
...
private:
    ...
    static ResTypeParserTester* s_inst;
...
#endif // RES_TYPE_PARSER_TESTER_H
