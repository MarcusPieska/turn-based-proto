...
MvtCostParserTester* MvtCostParserTester::s_inst = NULL;

//================================================================================================================================
//=> - MvtCostParserTester implementation -
//================================================================================================================================

MvtCostParserTester::MvtCostParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
    m_city_flag_sd(NULL),
...
void MvtCostParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void MvtCostParserTester::set_city_flag_sd (const CityFlagStaticData* sd) {

    m_city_flag_sd = sd;

}

void MvtCostParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void MvtCostParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void MvtCostParserTester::set_mvt_cost_sd (const MvtCostStaticData* sd) {

    m_mvt_cost_sd = sd;

}

void MvtCostParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void MvtCostParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void MvtCostParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void MvtCostParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void MvtCostParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void MvtCostParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void MvtCostParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void MvtCostParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

FILE* MvtCostParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void MvtCostParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_MVT_COST", "w");
}

void MvtCostParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void MvtCostParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool MvtCostParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 MvtCostParserTester::st_building_n2i (cstr name) {
...
u16 MvtCostParserTester::st_city_flag_n2i (cstr name) {
...
u16 MvtCostParserTester::st_civ_n2i (cstr name) {
...
u16 MvtCostParserTester::st_civ_trait_n2i (cstr name) {
...
u16 MvtCostParserTester::st_mvt_cost_n2i (cstr name) {
...
u16 MvtCostParserTester::st_resource_n2i (cstr name) {
...
u16 MvtCostParserTester::st_res_dist_n2i (cstr name) {
...
u16 MvtCostParserTester::st_small_wonder_n2i (cstr name) {
...
u16 MvtCostParserTester::st_tech_n2i (cstr name) {
...
u16 MvtCostParserTester::st_unit_n2i (cstr name) {
...
u16 MvtCostParserTester::st_unit_action_n2i (cstr name) {
...
u16 MvtCostParserTester::st_unit_type_n2i (cstr name) {
...
u16 MvtCostParserTester::st_wonder_n2i (cstr name) {
...
void MvtCostParserTester::pr_u16 (cstr label, u16 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void MvtCostParserTester::pr_u32 (cstr label, u32 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void MvtCostParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void MvtCostParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void MvtCostParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void MvtCostParserTester::pr_item (cstr name, const MvtCostStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
    pr_u16("cost", item.cost);
}

int MvtCostParserTester::run () {
    s_inst = this;
    NameToIdxCbs cbs = {};
    ...
    if (!ld_sm(raw_items, paths.get_path_to_mvt_costs())) {
        s_inst = NULL;
        return 0;
    }
    ...
    MvtCostParser parser(raw_items, cbs);
    MvtCostStaticDataStruct* parsed_data = parser.parse_data_dependencies();
    if (m_plvl >= 2) {
