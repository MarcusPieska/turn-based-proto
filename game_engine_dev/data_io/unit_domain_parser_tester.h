...
#ifndef UNIT_DOMAIN_PARSER_TESTER_H
#define UNIT_DOMAIN_PARSER_TESTER_H
...
//================================================================================================================================
//=> - UnitDomainParserTester class -
//================================================================================================================================

class UnitDomainParserTester {
public:
    UnitDomainParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const UnitDomainStaticDataStruct& item);
...
private:
    ...
    static UnitDomainParserTester* s_inst;
...
#endif // UNIT_DOMAIN_PARSER_TESTER_H
