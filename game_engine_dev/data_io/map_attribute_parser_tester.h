...
#ifndef MAP_ATTRIBUTE_PARSER_TESTER_H
#define MAP_ATTRIBUTE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - MapAttributeParserTester class -
//================================================================================================================================

class MapAttributeParserTester {
public:
    MapAttributeParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const MapAttributeStaticDataStruct& item);
...
private:
    ...
    static MapAttributeParserTester* s_inst;
...
#endif // MAP_ATTRIBUTE_PARSER_TESTER_H
