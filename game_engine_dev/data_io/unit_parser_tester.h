...
#ifndef UNIT_PARSER_TESTER_H
#define UNIT_PARSER_TESTER_H
...
//================================================================================================================================
//=> - UnitParserTester class -
//================================================================================================================================

class UnitParserTester {
public:
    UnitParserTester ();
    void set_plvl (int lvl);
    int run ();
    void pr_item (const UnitStaticDataStruct& item);
...
private:
    ...
    static UnitParserTester* s_inst;
