...
#ifndef TILE_YIELD_TYPE_PARSER_TESTER_H
#define TILE_YIELD_TYPE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - TileYieldTypeParserTester class -
//================================================================================================================================

class TileYieldTypeParserTester {
public:
    TileYieldTypeParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const TileYieldTypeStaticDataStruct& item);
...
private:
    ...
    static TileYieldTypeParserTester* s_inst;
...
#endif // TILE_YIELD_TYPE_PARSER_TESTER_H
