...
void CityFlagParserTester::set_city_job_sd (const CityJobStaticData* sd) {
...
void CityFlagParserTester::set_tile_attribute_sd (const TileAttributeStaticData* sd) {
...
void CityFlagParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void CityFlagParserTester::set_res_type_sd (const ResTypeStaticData* sd) {
...
void CityFlagParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {
...
void CityFlagParserTester::set_worker_job_sd (const WorkerJobStaticData* sd) {

    m_worker_job_sd = sd;

}

void CityFlagParserTester::set_worker_job_imp_sd (const WorkerJobImpStaticData* sd) {

    m_worker_job_imp_sd = sd;

}

void CityFlagParserTester::set_tile_yield_type_sd (const TileYieldTypeStaticData* sd) {

    m_tile_yield_type_sd = sd;

}

void CityFlagParserTester::set_improvement_yield_sd (const ImprovementYieldStaticData* sd) {
...
u16 CityFlagParserTester::st_city_job_n2i (cstr name) {
...
u16 CityFlagParserTester::st_tile_attribute_n2i (cstr name) {
...
u16 CityFlagParserTester::st_res_dist_n2i (cstr name) {
...
u16 CityFlagParserTester::st_res_type_n2i (cstr name) {
...
u16 CityFlagParserTester::st_unit_role_n2i (cstr name) {
...
u16 CityFlagParserTester::st_worker_job_n2i (cstr name) {
...
u16 CityFlagParserTester::st_worker_job_imp_n2i (cstr name) {
...
u16 CityFlagParserTester::st_tile_yield_type_n2i (cstr name) {
...
u16 CityFlagParserTester::st_improvement_yield_n2i (cstr name) {
...
void CityFlagParserTester::pr_i16 (cstr label, i16 value) {
    fprintf(out(), "  %s: %d\n", label, (int)value);
}
...
void CityFlagParserTester::pr_item (cstr name, const CityFlagStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
...
int CityFlagParserTester::run () {
    ...
    if (!ld_sm(raw_items, paths.get_path_to_city_flags())) {
        s_inst = NULL;
        return 0;
    }
