...
#ifndef RES_DIST_PARSER_TESTER_H
#define RES_DIST_PARSER_TESTER_H
...
//================================================================================================================================
//=> - ResDistParserTester class -
//================================================================================================================================

class ResDistParserTester {
public:
    ResDistParserTester ();
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const ResDistStaticDataStruct& item);
...
private:
    ...
    static ResDistParserTester* s_inst;
    ...
    void pr_plc (u8 has_plc, const ResPlacement& plc);
};

#endif // RES_DIST_PARSER_TESTER_H
