...
#ifndef TECH_ERA_PARSER_TESTER_H
#define TECH_ERA_PARSER_TESTER_H
...
//================================================================================================================================
//=> - TechEraParserTester class -
//================================================================================================================================

class TechEraParserTester {
public:
    TechEraParserTester ();
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const TechEraStaticDataStruct& item);
...
private:
    ...
    static TechEraParserTester* s_inst;
...
#endif // TECH_ERA_PARSER_TESTER_H
