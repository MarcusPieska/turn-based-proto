...
CityJobParserTester* CityJobParserTester::s_inst = NULL;

//================================================================================================================================
//=> - CityJobParserTester implementation -
//================================================================================================================================

CityJobParserTester::CityJobParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
...
void CityJobParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void CityJobParserTester::set_toggle_city_sd (const ToggleCityStaticData* sd) {

    m_toggle_city_sd = sd;

}

void CityJobParserTester::set_toggle_civ_sd (const ToggleCivStaticData* sd) {

    m_toggle_civ_sd = sd;

}

void CityJobParserTester::set_toggle_global_sd (const ToggleGlobalStaticData* sd) {

    m_toggle_global_sd = sd;

}

void CityJobParserTester::set_city_job_sd (const CityJobStaticData* sd) {

    m_city_job_sd = sd;

}

void CityJobParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void CityJobParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void CityJobParserTester::set_tile_attribute_sd (const TileAttributeStaticData* sd) {

    m_tile_attribute_sd = sd;

}

void CityJobParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void CityJobParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void CityJobParserTester::set_res_type_sd (const ResTypeStaticData* sd) {

    m_res_type_sd = sd;

}

void CityJobParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void CityJobParserTester::set_tech_era_sd (const TechEraStaticData* sd) {

    m_tech_era_sd = sd;

}

void CityJobParserTester::set_tech_age_sd (const TechAgeStaticData* sd) {

    m_tech_age_sd = sd;

}

void CityJobParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void CityJobParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void CityJobParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {

    m_unit_role_sd = sd;

}

void CityJobParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void CityJobParserTester::set_unit_domain_sd (const UnitDomainStaticData* sd) {

    m_unit_domain_sd = sd;

}

void CityJobParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void CityJobParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

void CityJobParserTester::set_map_overlay_sd (const MapOverlayStaticData* sd) {

    m_map_overlay_sd = sd;

}

void CityJobParserTester::set_map_attribute_sd (const MapAttributeStaticData* sd) {

    m_map_attribute_sd = sd;

}

void CityJobParserTester::set_map_terrain_sd (const MapTerrainStaticData* sd) {

    m_map_terrain_sd = sd;

}

void CityJobParserTester::set_map_climate_sd (const MapClimateStaticData* sd) {

    m_map_climate_sd = sd;

}

void CityJobParserTester::set_worker_job_target_sd (const WorkerJobTargetStaticData* sd) {

    m_worker_job_target_sd = sd;

}

void CityJobParserTester::set_worker_job_type_sd (const WorkerJobTypeStaticData* sd) {
...
FILE* CityJobParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void CityJobParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_CITY_JOB", "w");
}

void CityJobParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void CityJobParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool CityJobParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 CityJobParserTester::st_building_n2i (cstr name) {
...
u16 CityJobParserTester::st_toggle_city_n2i (cstr name) {
...
u16 CityJobParserTester::st_toggle_civ_n2i (cstr name) {
...
u16 CityJobParserTester::st_toggle_global_n2i (cstr name) {
...
u16 CityJobParserTester::st_city_job_n2i (cstr name) {
...
u16 CityJobParserTester::st_civ_n2i (cstr name) {
...
u16 CityJobParserTester::st_civ_trait_n2i (cstr name) {
...
u16 CityJobParserTester::st_tile_attribute_n2i (cstr name) {
...
u16 CityJobParserTester::st_resource_n2i (cstr name) {
...
u16 CityJobParserTester::st_res_dist_n2i (cstr name) {
...
u16 CityJobParserTester::st_res_type_n2i (cstr name) {
...
u16 CityJobParserTester::st_small_wonder_n2i (cstr name) {
...
u16 CityJobParserTester::st_tech_era_n2i (cstr name) {
...
u16 CityJobParserTester::st_tech_age_n2i (cstr name) {
...
u16 CityJobParserTester::st_tech_n2i (cstr name) {
...
u16 CityJobParserTester::st_unit_action_n2i (cstr name) {
...
u16 CityJobParserTester::st_unit_role_n2i (cstr name) {
...
u16 CityJobParserTester::st_unit_type_n2i (cstr name) {
...
u16 CityJobParserTester::st_unit_domain_n2i (cstr name) {
...
u16 CityJobParserTester::st_unit_n2i (cstr name) {
...
u16 CityJobParserTester::st_wonder_n2i (cstr name) {
...
u16 CityJobParserTester::st_map_overlay_n2i (cstr name) {
...
u16 CityJobParserTester::st_map_attribute_n2i (cstr name) {
...
u16 CityJobParserTester::st_map_terrain_n2i (cstr name) {
...
u16 CityJobParserTester::st_map_climate_n2i (cstr name) {
...
u16 CityJobParserTester::st_worker_job_target_n2i (cstr name) {
...
u16 CityJobParserTester::st_worker_job_type_n2i (cstr name) {
...
u16 CityJobParserTester::st_worker_job_n2i (cstr name) {
...
void CityJobParserTester::pr_i16 (cstr label, i16 value) {
    fprintf(out(), "  %s: %d\n", label, (int)value);
}

void CityJobParserTester::pr_u32 (cstr label, u32 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void CityJobParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void CityJobParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void CityJobParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void CityJobParserTester::pr_item (cstr name, const CityJobStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
    ...
    pr_u16("slots", item.slots);
    pr_fx("effects", item.effects);
}

int CityJobParserTester::run () {
    s_inst = this;
    NameToIdxCbs cbs = {};
    ...
    CityJobParser parser(raw_items, cbs);
    CityJobStaticDataStruct* parsed_data = parser.parse_data_dependencies();
    if (m_plvl >= 2) {
