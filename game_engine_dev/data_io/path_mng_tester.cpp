...
void note_all_paths_exist (const PathMng& paths, cstr tag) {
        ...
        { char _buf[96]; std::snprintf(_buf, sizeof(_buf), "%s tech_eras exists", tag); note_result(does_file_exist(paths.get_path_to_tech_eras()), _buf); }
        { char _buf[96]; std::snprintf(_buf, sizeof(_buf), "%s tech_ages exists", tag); note_result(does_file_exist(paths.get_path_to_tech_ages()), _buf); }
        ...
        { char _buf[96]; std::snprintf(_buf, sizeof(_buf), "%s unit_domains exists", tag); note_result(does_file_exist(paths.get_path_to_unit_domains()), _buf); }
        ...
        { char _buf[96]; std::snprintf(_buf, sizeof(_buf), "%s trait_affinity exists", tag); note_result(does_file_exist(paths.get_path_to_trait_affinity()), _buf); }
