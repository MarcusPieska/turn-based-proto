...
void BuildingParserTester::set_toggle_city_sd (const ToggleCityStaticData* sd) {

    m_toggle_city_sd = sd;

}

void BuildingParserTester::set_toggle_civ_sd (const ToggleCivStaticData* sd) {

    m_toggle_civ_sd = sd;

}

void BuildingParserTester::set_toggle_global_sd (const ToggleGlobalStaticData* sd) {

    m_toggle_global_sd = sd;

}

void BuildingParserTester::set_city_job_sd (const CityJobStaticData* sd) {
...
void BuildingParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void BuildingParserTester::set_res_type_sd (const ResTypeStaticData* sd) {
...
void BuildingParserTester::set_tech_era_sd (const TechEraStaticData* sd) {

    m_tech_era_sd = sd;

}

void BuildingParserTester::set_tech_age_sd (const TechAgeStaticData* sd) {
...
void BuildingParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {
...
void BuildingParserTester::set_unit_domain_sd (const UnitDomainStaticData* sd) {
...
void BuildingParserTester::set_map_terrain_sd (const MapTerrainStaticData* sd) {

    m_map_terrain_sd = sd;

}

void BuildingParserTester::set_map_climate_sd (const MapClimateStaticData* sd) {
...
void BuildingParserTester::set_worker_job_type_sd (const WorkerJobTypeStaticData* sd) {

    m_worker_job_type_sd = sd;

}

void BuildingParserTester::set_worker_job_sd (const WorkerJobStaticData* sd) {

    m_worker_job_sd = sd;

}

void BuildingParserTester::set_worker_job_imp_sd (const WorkerJobImpStaticData* sd) {

    m_worker_job_imp_sd = sd;

}

void BuildingParserTester::set_tile_yield_type_sd (const TileYieldTypeStaticData* sd) {

    m_tile_yield_type_sd = sd;

}

void BuildingParserTester::set_improvement_yield_sd (const ImprovementYieldStaticData* sd) {
...
u16 BuildingParserTester::st_toggle_city_n2i (cstr name) {
...
u16 BuildingParserTester::st_toggle_civ_n2i (cstr name) {
...
u16 BuildingParserTester::st_toggle_global_n2i (cstr name) {
...
u16 BuildingParserTester::st_city_job_n2i (cstr name) {
...
u16 BuildingParserTester::st_res_dist_n2i (cstr name) {
...
u16 BuildingParserTester::st_res_type_n2i (cstr name) {
...
u16 BuildingParserTester::st_tech_era_n2i (cstr name) {
...
u16 BuildingParserTester::st_tech_age_n2i (cstr name) {
...
u16 BuildingParserTester::st_unit_role_n2i (cstr name) {
...
u16 BuildingParserTester::st_unit_domain_n2i (cstr name) {
...
u16 BuildingParserTester::st_map_terrain_n2i (cstr name) {
...
u16 BuildingParserTester::st_map_climate_n2i (cstr name) {
...
u16 BuildingParserTester::st_worker_job_n2i (cstr name) {
...
u16 BuildingParserTester::st_worker_job_imp_n2i (cstr name) {
...
u16 BuildingParserTester::st_tile_yield_type_n2i (cstr name) {
...
u16 BuildingParserTester::st_improvement_yield_n2i (cstr name) {
...
void BuildingParserTester::pr_item (cstr name, const BuildingStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
...
int BuildingParserTester::run () {
    ...
    if (!ld_sm(raw_items, paths.get_path_to_buildings())) {
        s_inst = NULL;
        return 0;
    }
