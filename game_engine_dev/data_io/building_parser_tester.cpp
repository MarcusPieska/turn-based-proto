...
BuildingParserTester* BuildingParserTester::s_inst = NULL;

//================================================================================================================================
//=> - BuildingParserTester implementation -
//================================================================================================================================

BuildingParserTester::BuildingParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
    m_city_flag_sd(NULL),
...
void BuildingParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void BuildingParserTester::set_city_flag_sd (const CityFlagStaticData* sd) {

    m_city_flag_sd = sd;

}

void BuildingParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void BuildingParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void BuildingParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void BuildingParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void BuildingParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void BuildingParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void BuildingParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void BuildingParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {
...
FILE* BuildingParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void BuildingParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_BUILDING", "w");
}

void BuildingParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void BuildingParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool BuildingParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 BuildingParserTester::st_building_n2i (cstr name) {
...
u16 BuildingParserTester::st_city_flag_n2i (cstr name) {
...
u16 BuildingParserTester::st_civ_n2i (cstr name) {
...
u16 BuildingParserTester::st_civ_trait_n2i (cstr name) {
...
u16 BuildingParserTester::st_small_wonder_n2i (cstr name) {
...
u16 BuildingParserTester::st_tech_n2i (cstr name) {
...
u16 BuildingParserTester::st_unit_n2i (cstr name) {
...
u16 BuildingParserTester::st_unit_action_n2i (cstr name) {
...
u16 BuildingParserTester::st_unit_type_n2i (cstr name) {
...
u16 BuildingParserTester::st_wonder_n2i (cstr name) {
...
void BuildingParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void BuildingParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void BuildingParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void BuildingParserTester::pr_item (const BuildingStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", item.name.c_str());
...
int BuildingParserTester::run () {
    ...
    if (!raw_items.load_file_content("../game_config.buildings")) {
        s_inst = NULL;
        return 0;
    }
