...
#ifndef IMPROVEMENT_YIELD_PARSER_TESTER_H
#define IMPROVEMENT_YIELD_PARSER_TESTER_H
...
//================================================================================================================================
//=> - ImprovementYieldParserTester class -
//================================================================================================================================

class ImprovementYieldParserTester {
public:
    ImprovementYieldParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const ImprovementYieldStaticDataStruct& item);
...
private:
    ...
    static ImprovementYieldParserTester* s_inst;
...
#endif // IMPROVEMENT_YIELD_PARSER_TESTER_H
