...
#ifndef TILE_ATTRIBUTE_PARSER_TESTER_H
#define TILE_ATTRIBUTE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - TileAttributeParserTester class -
//================================================================================================================================

class TileAttributeParserTester {
public:
    TileAttributeParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const TileAttributeStaticDataStruct& item);
...
private:
    ...
    static TileAttributeParserTester* s_inst;
...
#endif // TILE_ATTRIBUTE_PARSER_TESTER_H
