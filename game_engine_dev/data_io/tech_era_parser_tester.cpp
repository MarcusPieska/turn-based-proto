...
TechEraParserTester* TechEraParserTester::s_inst = NULL;

//================================================================================================================================
//=> - TechEraParserTester implementation -
//================================================================================================================================

TechEraParserTester::TechEraParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
...
void TechEraParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void TechEraParserTester::set_toggle_city_sd (const ToggleCityStaticData* sd) {

    m_toggle_city_sd = sd;

}

void TechEraParserTester::set_toggle_civ_sd (const ToggleCivStaticData* sd) {

    m_toggle_civ_sd = sd;

}

void TechEraParserTester::set_toggle_global_sd (const ToggleGlobalStaticData* sd) {

    m_toggle_global_sd = sd;

}

void TechEraParserTester::set_city_job_sd (const CityJobStaticData* sd) {

    m_city_job_sd = sd;

}

void TechEraParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void TechEraParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void TechEraParserTester::set_tile_attribute_sd (const TileAttributeStaticData* sd) {

    m_tile_attribute_sd = sd;

}

void TechEraParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void TechEraParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void TechEraParserTester::set_res_type_sd (const ResTypeStaticData* sd) {

    m_res_type_sd = sd;

}

void TechEraParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void TechEraParserTester::set_tech_era_sd (const TechEraStaticData* sd) {

    m_tech_era_sd = sd;

}

void TechEraParserTester::set_tech_age_sd (const TechAgeStaticData* sd) {

    m_tech_age_sd = sd;

}

void TechEraParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void TechEraParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void TechEraParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {

    m_unit_role_sd = sd;

}

void TechEraParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void TechEraParserTester::set_unit_domain_sd (const UnitDomainStaticData* sd) {

    m_unit_domain_sd = sd;

}

void TechEraParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void TechEraParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

void TechEraParserTester::set_map_overlay_sd (const MapOverlayStaticData* sd) {

    m_map_overlay_sd = sd;

}

void TechEraParserTester::set_map_attribute_sd (const MapAttributeStaticData* sd) {

    m_map_attribute_sd = sd;

}

void TechEraParserTester::set_map_terrain_sd (const MapTerrainStaticData* sd) {

    m_map_terrain_sd = sd;

}

void TechEraParserTester::set_map_climate_sd (const MapClimateStaticData* sd) {

    m_map_climate_sd = sd;

}

void TechEraParserTester::set_worker_job_target_sd (const WorkerJobTargetStaticData* sd) {

    m_worker_job_target_sd = sd;

}

void TechEraParserTester::set_worker_job_type_sd (const WorkerJobTypeStaticData* sd) {

    m_worker_job_type_sd = sd;

}

void TechEraParserTester::set_worker_job_sd (const WorkerJobStaticData* sd) {

    m_worker_job_sd = sd;

}

void TechEraParserTester::set_worker_job_imp_sd (const WorkerJobImpStaticData* sd) {

    m_worker_job_imp_sd = sd;

}

void TechEraParserTester::set_tile_yield_type_sd (const TileYieldTypeStaticData* sd) {

    m_tile_yield_type_sd = sd;

}

void TechEraParserTester::set_improvement_yield_sd (const ImprovementYieldStaticData* sd) {

    m_improvement_yield_sd = sd;

}

FILE* TechEraParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void TechEraParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_TECH_ERA", "w");
}

void TechEraParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void TechEraParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool TechEraParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 TechEraParserTester::st_building_n2i (cstr name) {
...
u16 TechEraParserTester::st_toggle_city_n2i (cstr name) {
...
u16 TechEraParserTester::st_toggle_civ_n2i (cstr name) {
...
u16 TechEraParserTester::st_toggle_global_n2i (cstr name) {
...
u16 TechEraParserTester::st_city_job_n2i (cstr name) {
...
u16 TechEraParserTester::st_civ_n2i (cstr name) {
...
u16 TechEraParserTester::st_civ_trait_n2i (cstr name) {
...
u16 TechEraParserTester::st_tile_attribute_n2i (cstr name) {
...
u16 TechEraParserTester::st_resource_n2i (cstr name) {
...
u16 TechEraParserTester::st_res_dist_n2i (cstr name) {
...
u16 TechEraParserTester::st_res_type_n2i (cstr name) {
...
u16 TechEraParserTester::st_small_wonder_n2i (cstr name) {
...
u16 TechEraParserTester::st_tech_era_n2i (cstr name) {
...
u16 TechEraParserTester::st_tech_age_n2i (cstr name) {
...
u16 TechEraParserTester::st_tech_n2i (cstr name) {
...
u16 TechEraParserTester::st_unit_action_n2i (cstr name) {
...
u16 TechEraParserTester::st_unit_role_n2i (cstr name) {
...
u16 TechEraParserTester::st_unit_type_n2i (cstr name) {
...
u16 TechEraParserTester::st_unit_domain_n2i (cstr name) {
...
u16 TechEraParserTester::st_unit_n2i (cstr name) {
...
u16 TechEraParserTester::st_wonder_n2i (cstr name) {
...
u16 TechEraParserTester::st_map_overlay_n2i (cstr name) {
...
u16 TechEraParserTester::st_map_attribute_n2i (cstr name) {
...
u16 TechEraParserTester::st_map_terrain_n2i (cstr name) {
...
u16 TechEraParserTester::st_map_climate_n2i (cstr name) {
...
u16 TechEraParserTester::st_worker_job_target_n2i (cstr name) {
...
u16 TechEraParserTester::st_worker_job_type_n2i (cstr name) {
...
u16 TechEraParserTester::st_worker_job_n2i (cstr name) {
...
u16 TechEraParserTester::st_worker_job_imp_n2i (cstr name) {
...
u16 TechEraParserTester::st_tile_yield_type_n2i (cstr name) {
...
u16 TechEraParserTester::st_improvement_yield_n2i (cstr name) {
...
void TechEraParserTester::pr_u16 (cstr label, u16 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void TechEraParserTester::pr_i16 (cstr label, i16 value) {
    fprintf(out(), "  %s: %d\n", label, (int)value);
}

void TechEraParserTester::pr_u32 (cstr label, u32 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void TechEraParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void TechEraParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void TechEraParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void TechEraParserTester::pr_item (cstr name, const TechEraStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
    // No parsing instructions provided
}

int TechEraParserTester::run () {
    s_inst = this;
    NameToIdxCbs cbs = {};
    ...
    if (!ld_sm(raw_items, paths.get_path_to_tech_eras())) {
        s_inst = NULL;
        return 0;
    }
    ...
    TechEraParser parser(raw_items, cbs);
    TechEraStaticDataStruct* parsed_data = parser.parse_data_dependencies();
    if (m_plvl >= 2) {
