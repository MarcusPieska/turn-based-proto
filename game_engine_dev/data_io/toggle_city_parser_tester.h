...
#ifndef TOGGLE_CITY_PARSER_TESTER_H
#define TOGGLE_CITY_PARSER_TESTER_H
...
//================================================================================================================================
//=> - ToggleCityParserTester class -
//================================================================================================================================

class ToggleCityParserTester {
public:
    ToggleCityParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const ToggleCityStaticDataStruct& item);
...
private:
    ...
    static ToggleCityParserTester* s_inst;
...
#endif // TOGGLE_CITY_PARSER_TESTER_H
