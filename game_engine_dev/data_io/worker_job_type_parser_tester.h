...
#ifndef WORKER_JOB_TYPE_PARSER_TESTER_H
#define WORKER_JOB_TYPE_PARSER_TESTER_H
...
//================================================================================================================================
//=> - WorkerJobTypeParserTester class -
//================================================================================================================================

class WorkerJobTypeParserTester {
public:
    WorkerJobTypeParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const WorkerJobTypeStaticDataStruct& item);
...
private:
    ...
    static WorkerJobTypeParserTester* s_inst;
...
#endif // WORKER_JOB_TYPE_PARSER_TESTER_H
