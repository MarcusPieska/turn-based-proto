...
#ifndef WONDER_PARSER_TESTER_H
#define WONDER_PARSER_TESTER_H
...
public:
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (const WonderStaticDataStruct& item);
