...
UnitActionParserTester* UnitActionParserTester::s_inst = NULL;

//================================================================================================================================
//=> - UnitActionParserTester implementation -
//================================================================================================================================

UnitActionParserTester::UnitActionParserTester () : 
    m_plvl(0), 
    m_out(NULL), 
    m_building_sd(NULL),
    m_city_flag_sd(NULL),
...
void UnitActionParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void UnitActionParserTester::set_city_flag_sd (const CityFlagStaticData* sd) {

    m_city_flag_sd = sd;

}

void UnitActionParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void UnitActionParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void UnitActionParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void UnitActionParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void UnitActionParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void UnitActionParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void UnitActionParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void UnitActionParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void UnitActionParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

FILE* UnitActionParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void UnitActionParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_UNIT_ACTION", "w");
}

void UnitActionParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
...
void UnitActionParserTester::set_plvl (int lvl) {
    m_plvl = lvl;
}

bool UnitActionParserTester::ld_sm (StringManager& sm, cstr path) {
...
u16 UnitActionParserTester::st_building_n2i (cstr name) {
...
u16 UnitActionParserTester::st_city_flag_n2i (cstr name) {
...
u16 UnitActionParserTester::st_civ_n2i (cstr name) {
...
u16 UnitActionParserTester::st_civ_trait_n2i (cstr name) {
...
u16 UnitActionParserTester::st_resource_n2i (cstr name) {
...
u16 UnitActionParserTester::st_small_wonder_n2i (cstr name) {
...
u16 UnitActionParserTester::st_tech_n2i (cstr name) {
...
u16 UnitActionParserTester::st_unit_n2i (cstr name) {
...
u16 UnitActionParserTester::st_unit_action_n2i (cstr name) {
...
u16 UnitActionParserTester::st_unit_type_n2i (cstr name) {
...
u16 UnitActionParserTester::st_wonder_n2i (cstr name) {
...
void UnitActionParserTester::pr_u16 (cstr label, u16 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void UnitActionParserTester::pr_u32 (cstr label, u32 value) {
    fprintf(out(), "  %s: %u\n", label, value);
}

void UnitActionParserTester::pr_reqs (cstr label, const ItemReqsStruct& reqs) {
    fprintf(out(), "  %s:\n", label);
...
void UnitActionParserTester::pr_fx (cstr label, const ItemEffectsStruct& e) {
    fprintf(out(), "  %s:\n", label);
...
void UnitActionParserTester::pr_traits (cstr label, const CivTraitStruct& traits) {
    fprintf(out(), "  %s:\n", label);
...
void UnitActionParserTester::pr_item (const UnitActionStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", item.name.c_str());
    // No parsing instructions provided
}

int UnitActionParserTester::run () {
    s_inst = this;
    NameToIdxCbs cbs = {};
    ...
    if (!raw_items.load_file_content("../game_config.unit_actions")) {
        s_inst = NULL;
        return 0;
    }
