...
#ifndef TOGGLE_CIV_PARSER_TESTER_H
#define TOGGLE_CIV_PARSER_TESTER_H
...
//================================================================================================================================
//=> - ToggleCivParserTester class -
//================================================================================================================================

class ToggleCivParserTester {
public:
    ToggleCivParserTester ();
    void set_plvl (int lvl);
    int run ();
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const ToggleCivStaticDataStruct& item);
...
private:
    ...
    static ToggleCivParserTester* s_inst;
...
#endif // TOGGLE_CIV_PARSER_TESTER_H
