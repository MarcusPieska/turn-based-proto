...
void ResourceParserTester::set_toggle_city_sd (const ToggleCityStaticData* sd) {

    m_toggle_city_sd = sd;

}

void ResourceParserTester::set_toggle_civ_sd (const ToggleCivStaticData* sd) {

    m_toggle_civ_sd = sd;

}

void ResourceParserTester::set_toggle_global_sd (const ToggleGlobalStaticData* sd) {

    m_toggle_global_sd = sd;

}

void ResourceParserTester::set_city_job_sd (const CityJobStaticData* sd) {
...
void ResourceParserTester::set_tile_attribute_sd (const TileAttributeStaticData* sd) {
...
void ResourceParserTester::set_res_dist_sd (const ResDistStaticData* sd) {

    m_res_dist_sd = sd;

}

void ResourceParserTester::set_res_type_sd (const ResTypeStaticData* sd) {
...
void ResourceParserTester::set_tech_era_sd (const TechEraStaticData* sd) {

    m_tech_era_sd = sd;

}

void ResourceParserTester::set_tech_age_sd (const TechAgeStaticData* sd) {
...
void ResourceParserTester::set_unit_role_sd (const UnitRoleStaticData* sd) {
...
void ResourceParserTester::set_unit_domain_sd (const UnitDomainStaticData* sd) {
...
void ResourceParserTester::set_map_overlay_sd (const MapOverlayStaticData* sd) {

    m_map_overlay_sd = sd;

}

void ResourceParserTester::set_map_attribute_sd (const MapAttributeStaticData* sd) {

    m_map_attribute_sd = sd;

}

void ResourceParserTester::set_map_terrain_sd (const MapTerrainStaticData* sd) {

    m_map_terrain_sd = sd;

}

void ResourceParserTester::set_map_climate_sd (const MapClimateStaticData* sd) {

    m_map_climate_sd = sd;

}

void ResourceParserTester::set_worker_job_target_sd (const WorkerJobTargetStaticData* sd) {

    m_worker_job_target_sd = sd;

}

void ResourceParserTester::set_worker_job_type_sd (const WorkerJobTypeStaticData* sd) {

    m_worker_job_type_sd = sd;

}

void ResourceParserTester::set_worker_job_sd (const WorkerJobStaticData* sd) {

    m_worker_job_sd = sd;

}

void ResourceParserTester::set_worker_job_imp_sd (const WorkerJobImpStaticData* sd) {

    m_worker_job_imp_sd = sd;

}

void ResourceParserTester::set_tile_yield_type_sd (const TileYieldTypeStaticData* sd) {

    m_tile_yield_type_sd = sd;

}

void ResourceParserTester::set_improvement_yield_sd (const ImprovementYieldStaticData* sd) {
...
u16 ResourceParserTester::st_toggle_city_n2i (cstr name) {
...
u16 ResourceParserTester::st_toggle_civ_n2i (cstr name) {
...
u16 ResourceParserTester::st_toggle_global_n2i (cstr name) {
...
u16 ResourceParserTester::st_city_job_n2i (cstr name) {
...
u16 ResourceParserTester::st_tile_attribute_n2i (cstr name) {
...
u16 ResourceParserTester::st_res_dist_n2i (cstr name) {
...
u16 ResourceParserTester::st_res_type_n2i (cstr name) {
...
u16 ResourceParserTester::st_tech_era_n2i (cstr name) {
...
u16 ResourceParserTester::st_tech_age_n2i (cstr name) {
...
u16 ResourceParserTester::st_unit_role_n2i (cstr name) {
...
u16 ResourceParserTester::st_unit_domain_n2i (cstr name) {
...
u16 ResourceParserTester::st_map_overlay_n2i (cstr name) {
...
u16 ResourceParserTester::st_map_attribute_n2i (cstr name) {
...
u16 ResourceParserTester::st_map_terrain_n2i (cstr name) {
...
u16 ResourceParserTester::st_map_climate_n2i (cstr name) {
...
u16 ResourceParserTester::st_worker_job_target_n2i (cstr name) {
...
u16 ResourceParserTester::st_worker_job_type_n2i (cstr name) {
...
u16 ResourceParserTester::st_worker_job_n2i (cstr name) {
...
u16 ResourceParserTester::st_worker_job_imp_n2i (cstr name) {
...
u16 ResourceParserTester::st_tile_yield_type_n2i (cstr name) {
...
u16 ResourceParserTester::st_improvement_yield_n2i (cstr name) {
...
void ResourceParserTester::pr_i16 (cstr label, i16 value) {
    fprintf(out(), "  %s: %d\n", label, (int)value);
}
...
void ResourceParserTester::pr_item (cstr name, const ResourceStaticDataStruct& item) {
    fprintf(out(), "name: %s\n", name);
    ...
    pr_u16("res_dist_idx", item.res_dist_idx);
}
...
int ResourceParserTester::run () {
    ...
    if (!ld_sm(raw_items, paths.get_path_to_resources())) {
        s_inst = NULL;
        return 0;
    }
