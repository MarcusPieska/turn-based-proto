...
void ResourceParserTester::set_building_sd (const BuildingStaticData* sd) {

    m_building_sd = sd;

}

void ResourceParserTester::set_city_flag_sd (const CityFlagStaticData* sd) {

    m_city_flag_sd = sd;

}

void ResourceParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void ResourceParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void ResourceParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void ResourceParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void ResourceParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void ResourceParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void ResourceParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void ResourceParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void ResourceParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

FILE* ResourceParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void ResourceParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_RESOURCE", "w");
}

void ResourceParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
