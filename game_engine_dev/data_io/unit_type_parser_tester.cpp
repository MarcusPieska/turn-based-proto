...
void UnitTypeParserTester::set_building_sd (const BuildingStaticData* sd) {
...
void UnitTypeParserTester::set_civ_sd (const CivStaticData* sd) {

    m_civ_sd = sd;

}

void UnitTypeParserTester::set_civ_trait_sd (const CivTraitStaticData* sd) {

    m_civ_trait_sd = sd;

}

void UnitTypeParserTester::set_resource_sd (const ResourceStaticData* sd) {

    m_resource_sd = sd;

}

void UnitTypeParserTester::set_small_wonder_sd (const SmallWonderStaticData* sd) {

    m_small_wonder_sd = sd;

}

void UnitTypeParserTester::set_tech_sd (const TechStaticData* sd) {

    m_tech_sd = sd;

}

void UnitTypeParserTester::set_unit_sd (const UnitStaticData* sd) {

    m_unit_sd = sd;

}

void UnitTypeParserTester::set_unit_action_sd (const UnitActionStaticData* sd) {

    m_unit_action_sd = sd;

}

void UnitTypeParserTester::set_unit_type_sd (const UnitTypeStaticData* sd) {

    m_unit_type_sd = sd;

}

void UnitTypeParserTester::set_wonder_sd (const WonderStaticData* sd) {

    m_wonder_sd = sd;

}

FILE* UnitTypeParserTester::out () const {
    return m_out != NULL ? m_out : stdout;
}

void UnitTypeParserTester::open_writer () {
    if (m_out != NULL) {
        return;
    }
    m_out = fopen("RESULTS_NEW_UNIT_TYPE", "w");
}

void UnitTypeParserTester::close_writer () {
    if (m_out != NULL) {
        fclose(m_out);
        m_out = NULL;
    }
