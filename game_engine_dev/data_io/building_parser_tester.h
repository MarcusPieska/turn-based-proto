...
#ifndef BUILDING_PARSER_TESTER_H
#define BUILDING_PARSER_TESTER_H
...
//================================================================================================================================
//=> - BuildingParserTester class -
//================================================================================================================================

class BuildingParserTester {
public:
    BuildingParserTester ();
    void set_plvl (int lvl);
    int run ();
    void pr_item (const BuildingStaticDataStruct& item);
...
private:
    ...
    static BuildingParserTester* s_inst;
...
#endif // BUILDING_PARSER_TESTER_H
