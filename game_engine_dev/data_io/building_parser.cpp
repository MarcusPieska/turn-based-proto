...
//================================================================================================================================
//=> - BuildingParser implementation -
//================================================================================================================================

BuildingParser::BuildingParser (const std::vector<RawItem>& items, const NameToIdxCbs& map) : DataParserBase(items, map) {
}

BuildingStaticDataStruct* BuildingParser::parse_data_dependencies () {
    BuildingStaticDataStruct* parsed_data = new BuildingStaticDataStruct[m_item_count]();
