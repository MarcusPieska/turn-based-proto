...
#ifndef CITY_JOB_PARSER_TESTER_H
#define CITY_JOB_PARSER_TESTER_H
...
//================================================================================================================================
//=> - CityJobParserTester class -
//================================================================================================================================

class CityJobParserTester {
public:
    CityJobParserTester ();
    ...
    void open_writer ();
    void close_writer ();
    void pr_item (cstr name, const CityJobStaticDataStruct& item);
...
private:
    ...
    static CityJobParserTester* s_inst;
...
#endif // CITY_JOB_PARSER_TESTER_H
