...
i32 test_p1_adj_ensure_seas_basic (const P1_RunPrm& prm, const P1_Adj_LandAltitudePrm& lap) {
    char out_path[320];
...
i32 main (i32 argc, char* argv[]) {
    ...
    return test_p1_adj_ensure_seas_basic(prm, lap);
}
