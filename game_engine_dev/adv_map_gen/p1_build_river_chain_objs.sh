...
RIV_CHAIN_BASE_OBJS="generator_constants.o perlin_noise.o whiteboard.o wb_sheet.o wb_que_xy.o p1_gen_outline.o generate_terrain_rotation.o p1_gen_cont_outlines.o p1_gen_land_depth.o p1_adj_outline_fill.o p1_gen_shaped_outline.o p1_gen_river_pts.o p1_gen_river_sectors.o p1_gen_coastal_mtn_limits.o p1_tester_cli.o"

RIV_CHAIN_LINE_OBJS="$RIV_CHAIN_BASE_OBJS p1_gen_river_network.o p1_gen_river_lines.o"
