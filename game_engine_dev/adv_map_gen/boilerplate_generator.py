...
if __name__ == "__main__":
    if len(sys.argv) < 2 or len(sys.argv) > 3:
        die("Usage: python boilerplate_generator.py <file_tag> [pipeline]")
    ...
    file_prefix = pipe + "_gen_"
    class_prefix = pipe_macro + "_Gen_"
    macro_prefix = pipe_macro + "_GEN_"
    ...
    tpl_h = "BOILERPLATE_GEN.h"
    tpl_cpp = "BOILERPLATE_GEN.cpp"
    tpl_tester = "BOILERPLATE_GEN_tester.cpp"
    tpl_tester_py = "BOILERPLATE_tester.py"
    tpl_comp = "BOILERPLATE_GEN_comp"
