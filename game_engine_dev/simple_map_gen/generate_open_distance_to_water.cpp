...
static void bfs_open_land_to_water (u16 w, u16 h, const u8* terrain, u16* dist, u16* max_dist) {
...
u8* Generate_OpenDistanceToWater::generate (const u8* terrain, u16 w, u16 h) {
    ...
    u16 max_dist = 0;
    bfs_open_land_to_water(w, h, terrain, dist, &max_dist);
    u32 land_fin = 0;
    for (u32 i = 0; i < n; ++i) {
