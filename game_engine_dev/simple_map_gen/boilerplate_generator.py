...
if __name__ == "__main__":
    if len(sys.argv) < 2 or len(sys.argv) > 3:
        die("Usage: python boilerplate_generator.py <file_tag> [prefix]")
    ...
    tpl_h = "BOILERPLATE_GENERATOR.h"
    tpl_cpp = "BOILERPLATE_GENERATOR.cpp"
    tpl_tester = "BOILERPLATE_GENERATOR_tester.cpp"
    tpl_comp = "BOILERPLATE_GENERATOR_comp"
