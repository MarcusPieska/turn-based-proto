...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        die("Usage: python boilerplate.py <file_tag>")
    file_tag = sys.argv[1].strip()
    if not file_tag:
        die("Error: file_tag is empty.")
    if file_tag != sys.argv[1]:
        die("Error: file_tag must not have leading or trailing whitespace.")
    ...
    out_h = "generate_" + file_tag + ".h"
    out_cpp = "generate_" + file_tag + ".cpp"
    out_tester = "generate_" + file_tag + "_tester.cpp"
    out_comp = "generate_" + file_tag + "_comp"
    ...
    tpl_h = "BOILERPLATE.h"
    tpl_cpp = "BOILERPLATE.cpp"
    tpl_tester = "BOILERPLATE_tester.cpp"
    tpl_comp = "BOILERPLATE_comp"
